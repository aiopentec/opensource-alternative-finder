...
TOOLS = {
    ...
    'confluence':      {'name': 'Confluence',       'category': 'productivity',       'pricing': '$5.75–$11/user/month',    'license': 'Proprietary',               'website': 'https://atlassian.com/confluence', 'description': 'Team wiki and documentation tool from Atlassian. Used by 75,000+ organizations for internal knowledge bases.',       'founded': '2004', 'company': 'Atlassian'},
    'bookstack':       {'name': 'BookStack',        'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'MIT',                       'website': 'https://bookstackapp.com',    'description': 'Simple, self-hosted wiki platform for organizing documentation. Clean interface with pages, chapters, and books.',         'github': 'BookStackApp/BookStack',  'stars_approx': '15k'},
    'zendesk':         {'name': 'Zendesk',          'category': 'productivity',       'pricing': '$19–$115/user/month',     'license': 'Proprietary',               'website': 'https://zendesk.com',         'description': 'Leading customer support and ticketing platform used by 100,000+ businesses for help desk and customer service.',          'founded': '2007', 'company': 'Zendesk Inc'},
    'zammad':          {'name': 'Zammad',           'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://zammad.org',          'description': 'Open-source helpdesk and customer support ticketing system. Supports email, chat, phone, and social media.',               'github': 'zammad/zammad',           'stars_approx': '4k'},
    'calendly':        {'name': 'Calendly',         'category': 'productivity',       'pricing': 'Free / $8–$16/user/month','license': 'Proprietary',               'website': 'https://calendly.com',        'description': 'Popular scheduling automation tool. Eliminates back-and-forth emails for booking meetings and appointments.',               'founded': '2013', 'company': 'Calendly LLC'},
    'cal-com':         {'name': 'Cal.com',          'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://cal.com',             'description': 'Open-source Calendly alternative for scheduling. Fully self-hostable with a modern interface and deep integrations.',      'github': 'calcom/cal.com',          'stars_approx': '32k'},
    'intercom':        {'name': 'Intercom',         'category': 'communication',      'pricing': '$39–$139+/month',         'license': 'Proprietary',               'website': 'https://intercom.com',        'description': 'Customer messaging platform for sales, marketing, and support. Used by 25,000+ businesses for live chat and bots.',        'founded': '2011', 'company': 'Intercom Inc'},
    'chatwoot':        {'name': 'Chatwoot',         'category': 'communication',      'pricing': 'Free (self-hosted)',       'license': 'MIT',                       'website': 'https://chatwoot.com',        'description': 'Open-source customer support platform supporting live chat, email, and social channels in one inbox.',                    'github': 'chatwoot/chatwoot',       'stars_approx': '22k'},
    'postman':         {'name': 'Postman',          'category': 'developer-tools',    'pricing': 'Free / $14–$29/user/month','license': 'Proprietary',              'website': 'https://postman.com',         'description': 'The most widely used API development and testing platform. Used by 30 million developers worldwide.',                      'founded': '2014', 'company': 'Postman Inc'},
    'hoppscotch':      {'name': 'Hoppscotch',       'category': 'developer-tools',    'pricing': 'Free (self-hosted)',       'license': 'MIT',                       'website': 'https://hoppscotch.io',       'description': 'Lightweight open-source API development tool. Fast, browser-based, and self-hostable alternative to Postman.',             'github': 'hoppscotch/hoppscotch',   'stars_approx': '65k'},
    '1password':       {'name': '1Password',        'category': 'productivity',       'pricing': '$2.99–$7.99/user/month',  'license': 'Proprietary',               'website': 'https://1password.com',       'description': 'Leading password manager for individuals and teams. Stores passwords, cards, and secure notes with zero-knowledge.',        'founded': '2006', 'company': 'AgileBits'},
    'bitwarden':       {'name': 'Bitwarden',        'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://bitwarden.com',       'description': 'Open-source password manager that can be self-hosted. Full-featured free tier and transparent security audits.',           'github': 'bitwarden/server',        'stars_approx': '15k'},
    'adobe-photoshop': {'name': 'Adobe Photoshop',  'category': 'design',             'pricing': '$20.99–$54.99/month',     'license': 'Proprietary',               'website': 'https://adobe.com/photoshop', 'description': 'Industry-standard image editing software by Adobe. Used by photographers, designers, and artists worldwide.',            'founded': '1988', 'company': 'Adobe'},
    'gimp':            {'name': 'GIMP',             'category': 'design',             'pricing': 'Free',                    'license': 'GPL 3.0',                   'website': 'https://gimp.org',            'description': 'The GNU Image Manipulation Program. Powerful open-source image editor with extensive plugin support.',                    'github': 'GNOME/gimp',              'stars_approx': '4k'},
    'typeform':        {'name': 'Typeform',         'category': 'productivity',       'pricing': 'Free / $25–$83/month',    'license': 'Proprietary',               'website': 'https://typeform.com',        'description': 'Conversational form and survey tool known for its beautiful, interactive design. Popular for lead generation.',             'founded': '2012', 'company': 'Typeform'},
    'formbricks':      {'name': 'Formbricks',       'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://formbricks.com',      'description': 'Open-source survey and form tool. Self-hostable with in-product surveys, link surveys, and website surveys.',              'github': 'formbricks/formbricks',   'stars_approx': '9k'},
    'miro':            {'name': 'Miro',             'category': 'design',             'pricing': 'Free / $8–$16/user/month','license': 'Proprietary',               'website': 'https://miro.com',            'description': 'Online collaborative whiteboard platform used by 60 million users for brainstorming and visual collaboration.',             'founded': '2011', 'company': 'RealtimeBoard'},
    'excalidraw':      {'name': 'Excalidraw',       'category': 'design',             'pricing': 'Free',                    'license': 'MIT',                       'website': 'https://excalidraw.com',      'description': 'Open-source virtual whiteboard with a hand-drawn feel. Works in the browser with no account required.',                   'github': 'excalidraw/excalidraw',   'stars_approx': '90k'},
    'netlify':         {'name': 'Netlify',          'category': 'developer-tools',    'pricing': 'Free / $19–$99/month',    'license': 'Proprietary',               'website': 'https://netlify.com',         'description': 'Popular platform for deploying and hosting web apps and static sites. Known for its simple Git-based workflow.',            'founded': '2014', 'company': 'Netlify Inc'},
    'coolify':         {'name': 'Coolify',          'category': 'developer-tools',    'pricing': 'Free (self-hosted)',       'license': 'Apache 2.0',                'website': 'https://coolify.io',          'description': 'Open-source self-hostable platform for deploying apps, databases, and services. A full Heroku/Netlify alternative.',      'github': 'coollabsio/coolify',      'stars_approx': '35k'},
    'salesforce':      {'name': 'Salesforce',        'category': 'productivity',       'pricing': '$25–$300+/user/month',    'license': 'Proprietary',               'website': 'https://salesforce.com',      'description': 'The world\'s leading CRM platform. Used by 150,000+ companies for sales, service, marketing, and analytics.',               'founded': '1999', 'company': 'Salesforce Inc'},
    'espocrm':         {'name': 'EspoCRM',           'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://espocrm.com',         'description': 'Open-source CRM with a clean interface covering sales, contacts, leads, and reporting. Easy to self-host.',                'github': 'espocrm/espocrm',         'stars_approx': '2k'},
    'grammarly':       {'name': 'Grammarly',         'category': 'productivity',       'pricing': 'Free / $12–$15/month',    'license': 'Proprietary',               'website': 'https://grammarly.com',       'description': 'AI-powered writing assistant that checks grammar, spelling, style, and tone. Used by 30 million people daily.',              'founded': '2009', 'company': 'Grammarly Inc'},
    'languagetool':    {'name': 'LanguageTool',      'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'LGPL 2.1',                  'website': 'https://languagetool.org',    'description': 'Open-source grammar and spell checker supporting 30+ languages. Can be self-hosted or used via browser extension.',         'github': 'languagetool-org/languagetool', 'stars_approx': '12k'},
    'shopify':         {'name': 'Shopify',           'category': 'productivity',       'pricing': '$29–$299+/month',         'license': 'Proprietary',               'website': 'https://shopify.com',         'description': 'Leading e-commerce platform powering 4 million+ online stores. Easy to use with extensive app marketplace.',               'founded': '2006', 'company': 'Shopify Inc'},
    'woocommerce':     {'name': 'WooCommerce',       'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'GPL 3.0',                   'website': 'https://woocommerce.com',     'description': 'The world\'s most popular open-source e-commerce plugin for WordPress. Powers 28% of all online stores.',                  'github': 'woocommerce/woocommerce',  'stars_approx': '9k'},
    'lastpass':        {'name': 'LastPass',          'category': 'productivity',       'pricing': 'Free / $3–$4/user/month', 'license': 'Proprietary',               'website': 'https://lastpass.com',        'description': 'Popular cloud-based password manager. Has faced multiple security breaches in recent years.',                              'founded': '2008', 'company': 'GoTo'},
    'vaultwarden':     {'name': 'Vaultwarden',       'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://github.com/dani-garcia/vaultwarden', 'description': 'Lightweight self-hosted Bitwarden-compatible server. Runs on minimal hardware including a Raspberry Pi.', 'github': 'dani-garcia/vaultwarden',  'stars_approx': '39k'},
    'quickbooks':      {'name': 'QuickBooks',        'category': 'productivity',       'pricing': '$30–$200+/month',         'license': 'Proprietary',               'website': 'https://quickbooks.intuit.com','description': 'Leading small business accounting software from Intuit. Used by 7 million businesses for invoicing and bookkeeping.',    'founded': '1983', 'company': 'Intuit'},
    'akaunting':       {'name': 'Akaunting',         'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'GPL 3.0',                   'website': 'https://akaunting.com',       'description': 'Free, open-source accounting software for small businesses. Handles invoicing, expenses, and financial reporting.',        'github': 'akaunting/akaunting',      'stars_approx': '8k'},
    'docusign':        {'name': 'DocuSign',          'category': 'productivity',       'pricing': '$15–$65+/user/month',     'license': 'Proprietary',               'website': 'https://docusign.com',        'description': 'The world\'s leading e-signature platform. Used by 1 million+ customers for legally binding digital document signing.',    'founded': '2003', 'company': 'DocuSign Inc'},
    'docuseal':        {'name': 'DocuSeal',          'category': 'productivity',       'pricing': 'Free (self-hosted)',       'license': 'AGPL 3.0',                  'website': 'https://docuseal.co',         'description': 'Open-source DocuSign alternative for e-signatures and document completion. Simple, fast, and fully self-hostable.',       'github': 'docusealco/docuseal',      'stars_approx': '8k'},
    'sentry':          {'name': 'Sentry',            'category': 'developer-tools',    'pricing': 'Free / $26–$80+/month',   'license': 'Proprietary',               'website': 'https://sentry.io',           'description': 'Leading error tracking and application monitoring platform. Used by 4 million developers to fix crashes in real time.',   'founded': '2012', 'company': 'Functional Software'},
    'glitchtip':       {'name': 'GlitchTip',         'category': 'developer-tools',    'pricing': 'Free (self-hosted)',       'license': 'BSD',                       'website': 'https://glitchtip.com',       'description': 'Open-source error tracking compatible with the Sentry SDK. Simple to self-host with Docker.',                             'github': 'glitchtip/glitchtip',      'stars_approx': '2k'},
    'hotjar':          {'name': 'Hotjar',            'category': 'productivity',       'pricing': 'Free / $32–$80+/month',   'license': 'Proprietary',               'website': 'https://hotjar.com',          'description': 'Behavior analytics tool with heatmaps, session recordings, and surveys. Used by 1 million+ websites.',                   'founded': '2014', 'company': 'Hotjar Ltd'},
