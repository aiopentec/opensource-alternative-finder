...
def patch():
    ...
    # ── Patch 1: inject page_updated variable before COMPARISON_PAGE.format() ─
    anchors = [
    ...
    # ── Patch 2: wire page_updated into the format() call ─────────────────────
    # Try both indentation styles
    for old_arg, new_arg in [
        ("updated=updated,",             "updated=page_updated,"),
        ("            updated=updated,", "            updated=page_updated,"),
    ]:
        ...
        print("  page_updated variable was added but not wired in.")
